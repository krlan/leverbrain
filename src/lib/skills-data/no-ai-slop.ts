...
export const noAiSlop: SkillListing = {
  id: 'no-ai-slop',
  author: 'petergyang',
  slug: 'no-ai-slop',
  name: "No AI slop",
  tagline: "Edit drafts into sharper, more human writing while preserving the writer's personal voice, or detect AI-slop patterns...",
...
- **Open it up, don't dumb it down.** Keep the substance, nuance, and precision. Strip out only what makes it hard to read: jargon, long sententes, abstract nouns, and tangled structure.
...
**Binary contrasts.** "This is not X. It's Y." / "The question isn't X, it's Y." / "It's not just X but Y." State Y directly. "The question isn't the model. It's the eval." becomes "The eval matters more thant the model."
...
3. For a detect request, note the findings report described in Two jobs and stop.
...
6. Output the full edited draft and a short **What changed** section.`,
  whenToUse: "Use when you need to automate no ai slop processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["petergyang-skills","no-ai-slop"],
  stars: 400,
  weeklyInstalls: 60,
  totalPurchases: 488,
  featured: false,
  ...
  fileUrl: 'https://github.com/petergyang/no-ai-slop/blob/main/SKILL.md',
  useCases: ["Keep the user's meaning. Don't invent claims, examples, stats, or opinions. If something is unclear, ask.","Use active voice. \"The team shipped it Tuesday\" beats \"the decision emerged.\" Never let inanimate things do human verbs.","Make verbs do the work. Replace weak verb phrases with direct verbs. \"Made a decision\" becomes \"decided.\" \"Has the ability to\" becomes \"can.\"."],
  exampleUsage: "Apply no AI slop for my project",
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">No AI slop</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">Edit drafts into sharper, more human writing while preserving the writer's personal voice, or detect AI-slop patterns...</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">Edit drafts into sharper, more human writing while preserving the writer's personal voice, or detect AI-slop patterns without rewriting. Use when the user wants a draft clearer, more direct, more opinionated, or less AI-sounding, or asks whether writing reads as AI.</p>
