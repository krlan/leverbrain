...
export const prospecting: SkillListing = {
  id: 'prospecting',
  author: 'coreyhaines31',
  slug: 'prospecting',
  name: "Prospecting",
  tagline: "When the user wants to find, qualify, and build a list of prospects to reach out to — across B2B SaaS, general B2B, o...",
...
- **product-marketing**: For the ICP definition that anchors every prospecting engagement`,
  whenToUse: "Use when you need to automate prospecting processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["coreyhaines31-skills","prospecting"],
  stars: 412,
  weeklyInstalls: 151,
  totalPurchases: 676,
  featured: false,
  ...
  fileUrl: 'https://github.com/coreyhaines31/marketingskills/tree/main/skills/prospecting',
  useCases: ["Check for product marketing context first:.","Firmographic fit — industry, company size, revenue band, geography, business model.","Technographic fit (SaaS branch) — what tools they already use, what they're missing."],
  exampleUsage: "Build prospecting for my project",
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Prospecting</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">When the user wants to find, qualify, and build a list of prospects to reach out to — across B2B SaaS, general B2B, o...</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">When the user wants to find, qualify, and build a list of prospects to reach out to — across B2B SaaS, general B2B, or local small businesses. Also use when the user mentions "prospecting," "build a prospect list," "find prospects," "find leads," "lead gen list," "find SaaS companies that," "find B2B companies," "find local businesses," "ICP-fit accounts," "who should we go after," "outbound list," "target account list," "find clients near me," "businesses without websites," "prospect research," or "qualified leads." Use this for the list-building and qualification phase. For writing the outbound copy after the list is built, see cold-email. For deep competitive research on specific accounts, see competitor-profiling.</p>
