...
export const tasteSkillV1: SkillListing = {
  id: 'taste-skill-v1',
  author: 'Leonxlnx',
  slug: 'taste-skill-v1',
...
- [ ] Did you strictly isolate CPU-heavy perpetual animations in their own Client Components?`,
  ...
  priceUsdc: 0,
  category: "skill",
  tags: ["Leonxlnx-skills","taste-skill-v1"],
  stars: 424,
  weeklyInstalls: 131,
  totalPurchases: 264,
  featured: false,
  ...
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">The original v1 taste-skill, preserved for projects depending on its exact behavior. The current default is \`design-taste-frontend\` (v2 experimental), which is a substantial rewrite. Use this v1 install name only if you need exact backward compatibility.</p>
