...
export const followBuilders: SkillListing = {
  id: 'follow-builders',
  author: 'zarazhangrui',
  slug: 'follow-builders',
  name: "Follow builders",
  tagline: "AI builders digest — monitors top AI builders on X and YouTube podcasts, remixes their content into digestible summaries.",
  ...
  readme: `# Follow Builders, Not Influencers
...
3. Tell the user you're fetching fresh content (it takes a minute or two)`,
  whenToUse: "Use when you need to automate follow builders processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["zarazhangrui-skills","follow-builders"],
  stars: 390,
  weeklyInstalls: 40,
  totalPurchases: 221,
  featured: false,
  ...
  useCases: ["OpenClaw (PLATFORM=openclaw): Persistent agent with built-in messaging channels.","Other (Claude Code, Cursor, etc.): Non-persistent agent. Terminal closes = agent stops.","If OpenClaw: SKIP this step entirely. OpenClaw already delivers messages to the."],
  exampleUsage: "Build follow builders for my project",
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Follow builders</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">AI builders digest — monitors top AI builders on X and YouTube podcasts, remixes their content into digestible summaries.</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">AI builders digest — monitors top AI builders on X and YouTube podcasts, remixes their content into digestible summaries. Use when the user wants AI industry insights, builder updates, or invokes /ai. No API keys or dependencies required — all content is fetched from a central feed.</p>
