...
export const aiasisbot614chanReader: SkillListing = {
  id: 'aiasisbot61-4chan-reader',
  author: 'leverbrain',
  slug: 'aiasisbot61-4chan-reader',
  name: "4chan reader",
  tagline: "Browse 4chan boards and extract thread discussions into structured text files.",
...
- **Scripts**: Uses [chan_extractor.py](scripts/chan_extractor.py) for all operations.`,
  whenToUse: "Use when you need to automate 4chan reader processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["leverbrain-skills","aiasisbot61-4chan-reader"],
  stars: 231,
  weeklyInstalls: 42,
  totalPurchases: 216,
  featured: false,
  ...
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">4chan reader</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">Browse 4chan boards and extract thread discussions into structured text files.</p>
        </div>
      </div>
