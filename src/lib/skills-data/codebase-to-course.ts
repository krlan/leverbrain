...
export const codebaseToCourse: SkillListing = {
  id: 'codebase-to-course',
  author: 'zarazhangrui',
  slug: 'codebase-to-course',
  name: "Codebase to course",
  tagline: "Turn any codebase into a beautiful, interactive single-page HTML course that teaches how the code works to non-techni...",
...
- **\`references/interactive-elements.md\`** — Implementation patterns for every interactive element: drag-and-drop quizzes, multiple-choice quizzes, code↔English translations, group chat animations, message flow visualizations, architecture diagrams, pattern cards, callout boxes. Read the relevant sections during Phase 3.`,
  whenToUse: "Use when you need to automate codebase to course processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["zarazhangrui-skills","codebase-to-course","devtools"],
  stars: 499,
  weeklyInstalls: 60,
  totalPurchases: 1072,
  featured: false,
  ...
  useCases: ["Their goals are practical, not academic:.","Have enough technical knowledge to effectively steer AI coding tools — make better architectural and tech stack decisions.","Detect when AI is wrong — spot hallucinations, catch bad patterns, know when something smells off."],
  exampleUsage: "Create codebase to course for my project",
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Codebase to course</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">Turn any codebase into a beautiful, interactive single-page HTML course that teaches how the code works to non-techni...</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">Turn any codebase into a beautiful, interactive single-page HTML course that teaches how the code works to non-technical people. Use this skill whenever someone wants to create an interactive course, tutorial, or educational walkthrough from a codebase or project. Also trigger when users mention 'turn this into a course,' 'explain this codebase interactively,' 'teach this code,' 'interactive tutorial from code,' 'codebase walkthrough,' 'learn from this codebase,' or 'make a course from this project.' This skill produces a stunning, self-contained HTML file with scroll-based navigation, animated visualizations, embedded quizzes, and code-with-plain-English side-by-side translations.</p>
