...
export const competitors: SkillListing = {
  id: 'competitors',
  ...
  readme: `# Competitor & Alternative Pages
...
- **sales-enablement**: For internal sales collateral, decks, and objection docs`,
  whenToUse: "Use when you need to automate competitors processes.",
  price: "Free",
  priceUsdc: 0,
  category: "describe how each handles it, list strengths and limitations, give bottom line recommendation.",
  tags: ["coreyhaines31-skills","competitors"],
  stars: 100,
  weeklyInstalls: 70,
  totalPurchases: 556,
  featured: false,
  ...
  fileUrl: 'https://github.com/coreyhaines31/marketingskills/tree/main/skills/competitors',
  useCases: ["Check for product marketing context first:.","Core value proposition.","Key differentiators."],
  exampleUsage: "Create competitors for my project",
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Competitors</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">When the user wants to create competitor comparison or alternative pages for SEO and sales enablement.</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">When the user wants to create competitor comparison or alternative pages for SEO and sales enablement. Also use when the user mentions 'alternative page,' 'vs page,' 'competitor comparison,' 'comparison page,' '[Product] vs [Product],' '[Product] alternative,' 'competitive landing pages,' 'how do we compare to X,' 'battle card,' or 'competitor teardown.' Use this for any content that positions your product against competitors. Covers four formats: singular alternative, plural alternatives, you vs competitor, and competitor vs competitor. For sales-specific competitor docs, see sales-enablement.</p>
