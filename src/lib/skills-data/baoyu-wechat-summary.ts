...
export const baoyuWechatSummary: SkillListing = {
  id: 'baoyu-wechat-summary',
  author: 'baoyu',
  slug: 'baoyu-wechat-summary',
  name: 'Wechat Summary',
  tagline: 'Summarizes WeChat group chat highlights into a structured digest using the local wx-cli binary (https://github.',
...
- **wx-cli reinit**. If \`wx history\` suddenly returns nothing after a WeChat restart, the keys may be stale. Tell the user to run \`sudo wx init --force\` (while WeChat is running) and retry.`,
  whenToUse: 'Use when the user asks to "总结群聊", "群聊精华", "群聊摘要", "summarize group chat", "group chat digest", mentions a WeChat group name with a time range, says "帮我看看 XX 群最近聊了什么", "XX 群有什么值得看的", or asks to "回溯画像" / "初始化画像" / "backfill profiles". Adds the roast version when the user says "毒舌版", "roast 版", "再来个毒舌的", or similar.',
  price: 'Free',
  priceUsdc: 0,
  category: 'skill',
  tags: ["baoyu-skills","wechat-summary","social-media","sharing"],
  stars: 707,
  weeklyInstalls: 247,
  totalPurchases: 1229,
  featured: false,
