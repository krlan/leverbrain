...
export const softSkill: SkillListing = {
  id: 'soft-skill',
  author: 'Leonxlnx',
  slug: 'soft-skill',
  name: "Soft skill",
...
- [ ] The overall impression reads as "$150k agency build", not "template with nice fonts"`,
  ...
  priceUsdc: 0,
  category: "skill",
  tags: ["Leonxlnx-skills","soft-skill"],
  stars: 221,
  weeklyInstalls: 122,
  totalPurchases: 806,
  featured: false,
  ...
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">Teaches the AI to design like a high-end agency. Defines the exact fonts, spacing, shadows, card structures, and animations that make a website feel expensive. Blocks all the common defaults that make AI designs look cheap or generic.</p>
