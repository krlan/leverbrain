...
export const communityMarketing: SkillListing = {
...
- **customer-research**: For understanding your community members' needs and language`,
  whenToUse: "Use when you need to automate community marketing processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["coreyhaines31-skills","community-marketing"],
  stars: 114,
  weeklyInstalls: 200,
  totalPurchases: 877,
  featured: false,
  ...
  fileUrl: 'https://github.com/coreyhaines31/marketingskills/tree/main/skills/community-marketing',
  useCases: ["Check for product marketing context first:.","What is the product or brand? — What problem does it solve, who uses it.","What community platform(s) are in play? — Discord, Slack, Circle, Reddit, Facebook Groups, forum, etc."],
  ...
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Community marketing</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">Build and leverage online communities to drive product growth and brand loyalty.</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">Build and leverage online communities to drive product growth and brand loyalty. Use when the user wants to create a community strategy, grow a Discord or Slack community, manage a forum or subreddit, build brand advocates, increase word-of-mouth, drive community-led growth, engage users post-signup, or turn customers into evangelists. Trigger phrases: \\"build a community,\\" \\"community strategy,\\" \\"Discord community,\\" \\"Slack community,\\" \\"community-led growth,\\" \\"brand advocates,\\" \\"user community,\\" \\"forum strategy,\\" \\"community engagement,\\" \\"grow our community,\\" \\"ambassador program,\\" \\"community flywheel.\\"</p>
