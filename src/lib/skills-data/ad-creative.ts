...
export const adCreative: SkillListing = {
  id: 'ad-creative',
  author: 'coreyhaines31',
  slug: 'ad-creative',
  name: "Ad creative",
  tagline: "When the user wants to generate, iterate, or scale ad creative — headlines, descriptions, primary text, or full ad va...",
...
- **copy-editing**: For polishing ad copy before launch`,
  whenToUse: "Use when you need to automate ad creative processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["coreyhaines31-skills","ad-creative"],
  stars: 599,
  weeklyInstalls: 76,
  totalPurchases: 1076,
  featured: false,
  ...
  fileUrl: 'https://github.com/coreyhaines31/marketingskills/tree/main/skills/ad-creative',
  useCases: ["Check for product marketing context first:.","What ad format? (Search RSAs, display, social feed, stories, video).","Are there existing ads to iterate on, or starting from scratch?"],
  exampleUsage: "Generate ad creative for my project",
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Ad creative</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">When the user wants to generate, iterate, or scale ad creative — headlines, descriptions, primary text, or full ad va...</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">When the user wants to generate, iterate, or scale ad creative — headlines, descriptions, primary text, or full ad variations — for any paid advertising platform. Also use when the user mentions 'ad copy variations,' 'ad creative,' 'generate headlines,' 'RSA headlines,' 'bulk ad copy,' 'ad iterations,' 'creative testing,' 'ad performance optimization,' 'write me some ads,' 'Facebook ad copy,' 'Google ad headlines,' 'LinkedIn ad text,' or 'I need more ad variations.' Use this whenever someone needs to produce ad copy at scale or iterate on existing ads. For campaign strategy and targeting, see ads. For landing page copy, see copywriting.</p>
