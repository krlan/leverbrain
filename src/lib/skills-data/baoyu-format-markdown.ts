...
export const baoyuFormatMarkdown: SkillListing = {
  id: 'baoyu-format-markdown',
  author: 'baoyu',
  slug: 'baoyu-format-markdown',
  name: 'Format Markdown',
  tagline: 'Formats plain text or markdown files with frontmatter, titles, summaries, headings, bold, lists, and code blocks.',
...
Custom configurations via EXTEND.md. See **Preferences** section for paths and supported options.`,
  whenToUse: 'Use when user asks to "format markdown", "beautify article", "add formatting", or improve article layout. Outputs to {filename}-formatted.md.',
  price: 'Free',
  priceUsdc: 0,
  category: 'skill',
  tags: ["baoyu-skills","format-markdown","devtools","format"],
  stars: 433,
  weeklyInstalls: 129,
  totalPurchases: 793,
  featured: false,
