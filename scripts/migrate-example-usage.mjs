...
const HARDCODED = {
  ...
  'baoyu-danger-gemini-web':   'Search the web and summarize current findings for my research topic',
  ...
  'baoyu-electron-extract':    'Extract and process content from my Electron app',
  'baoyu-format-markdown':     'Format and clean up my messy markdown document',
  'baoyu-image-gen':           'Generate custom images for my project from text prompts',
  ...
  'baoyu-post-to-wechat':      'Format and publish my content to my WeChat Official Account',
  'baoyu-post-to-weibo':       'Publish my content to my Weibo account',
  ...
  'baoyu-translate':           'Translate my document into English while preserving formatting',
  'baoyu-url-to-markdown':     'Convert any URL into clean markdown for my notes',
  'baoyu-wechat-summary':      'Summarize a WeChat article into key takeaways for my team',
