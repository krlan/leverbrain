...
Custom configurations via EXTEND.md. See **Preferences** section for paths and supported options.`,
  ...
  useCases: ["Optimize web illustrations for fast page load performance.","Batch convert PNG/JPG images to modern WebP format.","Resize heavy screenshot mockups to match standard screen container ratios."],
  exampleUsage: "Compress all images in my project without losing quality",
