...
export const qiaomuDesign: SkillListing = {
  id: 'qiaomu-design',
  author: 'joeseesun',
  slug: 'qiaomu-design',
  name: "Qiaomu design",
  tagline: "> 内置 58 个真实网站的 DESIGN.",
  description: "> 内置 58 个真实网站的 DESIGN.md 参考库 + 七份工艺规范 > （动效 / 工程 / 发散 / 验收 / 动效审查 / 动效词汇 / Apple 流体交互）。 > 本版本的每一条新规则都来自一场 6 变体 × 7 任务 × 42 页面的受控对比实验的胜者。",
  readme: `name: qiaomu-design
description: >
...
- **qiaomu-design 早期版本** → 人格、三阶段工作流、58 站 DESIGN.md 库、风格推荐引擎`,
  whenToUse: "Use when you need to automate qiaomu design processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["joeseesun-skills","qiaomu-design","image","design"],
  stars: 125,
  weeklyInstalls: 166,
  totalPurchases: 376,
  featured: false,
  ...
  fileUrl: 'https://github.com/joeseesun/qiaomu-design/blob/main/SKILL.md',
  useCases: ["Jobs 式产品直觉：不是设计好看的界面，而是定义正确的体验.","Rams 式功能纯粹主义：少即是多，每一个元素必须有存在的理由.","敢于说\"不\"：当所有人都觉得\"差不多就行\"时，毫不留情地推翻重来."],
  ...
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Qiaomu design</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">> 内置 58 个真实网站的 DESIGN.</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">> 内置 58 个真实网站的 DESIGN.md 参考库 + 七份工艺规范 > （动效 / 工程 / 发散 / 验收 / 动效审查 / 动效词汇 / Apple 流体交互）。 > 本版本的每一条新规则都来自一场 6 变体 × 7 任务 × 42 页面的受控对比实验的胜者。</p>
