...
export const analytics: SkillListing = {
  id: 'analytics',
  author: 'davila7',
  slug: 'analytics',
  name: "Analytics",
...
- **revops**: For pipeline metrics, CRM tracking, and revenue attribution`,
  whenToUse: "Use when you need to automate analytics processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["davila7-skills","analytics"],
  stars: 547,
  weeklyInstalls: 60,
  totalPurchases: 495,
  featured: false,
  ...
  fileUrl: 'https://github.com/davila7/claude-code-templates/tree/main/cli-tool/components/skills/analytics',
  useCases: ["Check for product marketing context first:.","Business Context - What decisions will this data inform? What are key conversions?","Current State - What tracking exists? What tools are in use?"],
  exampleUsage: "Improve analytics for my project",
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Analytics</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">When the user wants to set up, improve, or audit analytics tracking and measurement.</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">When the user wants to set up, improve, or audit analytics tracking and measurement. Also use when the user mentions "set up tracking," "GA4," "Google Analytics," "conversion tracking," "event tracking," "UTM parameters," "tag manager," "GTM," "analytics implementation," "tracking plan," "how do I measure this," "track conversions," "attribution," "Mixpanel," "Segment," "are my events firing," or "analytics isn't working." Use this whenever someone asks how to know if something is working or wants to measure marketing results. For A/B test measurement, see ab-testing.</p>
