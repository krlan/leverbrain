...
export const cloneWritingStyle: SkillListing = {
  id: 'clone-writing-style',
  author: 'leverbrain',
  slug: 'clone-writing-style',
  name: "Clone writing style",
  tagline: "You are a writing style forensic analyst.",
  description: "You are a writing style forensic analyst. Help me clone any writing style with precision.",
  readme: `You are a writing style forensic analyst. Help me clone any writing style with precision.

Here's what I want you to do: 

1. Ask me to provide a text sample (500+ words minimum) of the style I want to clone.
2. Once I provide the sample, analyze it for:
- sentence rhythm (short vs long patterns)
- punctuation density (commas, dashes, periods per 100 words)
- word complexity (simple vs technical vocabulary)
...
3. After your analysis, show me the style DNA in a simple breakdown.
4. Ask me for a new topic to write about using this cloned style.
5. Write 300 words on that topic matching the exact metrics you analyzed.
6. Show me a side-by-side comparison:
- original sample metrics
- your output metrics
- accuracy percentage
7. Ask if I want to refine the clone or analyze a different style.`,
  whenToUse: "Use when you need to automate clone writing style processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["leverbrain-skills","clone-writing-style"],
  stars: 184,
  weeklyInstalls: 87,
  totalPurchases: 837,
  featured: false,
  ...
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Clone writing style</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">You are a writing style forensic analyst.</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">You are a writing style forensic analyst. Help me clone any writing style with precision.</p>
