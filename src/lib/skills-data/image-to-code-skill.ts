...
export const imageToCodeSkill: SkillListing = {
  id: 'image-to-code-skill',
  author: 'Leonxlnx',
  slug: 'image-to-code-skill',
  name: "Image to code",
  tagline: "Elite website image-to-code skill for Codex.",
  ...
  readme: `# CORE DIRECTIVE: IMAGE-FIRST WEBSITE DESIGN TO CODE
...
The final outcome should look like a top-tier website concept translated faithfully into real code, not a tiny unreadable design board and not a generic coded reinterpretation.`,
  whenToUse: "Use when you need to automate image to code processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["Leonxlnx-skills","image-to-code-skill","image","design","devtools"],
  stars: 506,
  weeklyInstalls: 165,
  totalPurchases: 277,
  featured: false,
  ...
  fileUrl: 'https://github.com/Leonxlnx/taste-skill/tree/main/skills/image-to-code-skill',
  useCases: ["Editorial brand pages.","Portfolio websites.","Premium multi-section websites."],
  ...
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Image to code</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">Elite website image-to-code skill for Codex.</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">Elite website image-to-code skill for Codex. For visually important web tasks, it must first generate the design image(s) itself, deeply analyze them, then implement the website to match them as closely as possible. In Codex, it must prefer large, readable, section-specific images instead of tiny compressed boards, generate fresh standalone images for sections or detail views instead of cropping old ones, avoid lazy under-generation, avoid cards-inside-cards-inside-cards UI, and keep the hero clean, spacious, readable, and visible on a small laptop.</p>
