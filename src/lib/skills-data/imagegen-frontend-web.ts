...
export const imagegenFrontendWeb: SkillListing = {
  id: 'imagegen-frontend-web',
  author: 'Leonxlnx',
  slug: 'imagegen-frontend-web',
  name: "Imagegen frontend web",
  tagline: "Elite frontend image-direction skill for generating premium, conversion-aware website design references.",
  ...
  readme: `# HARD OUTPUT RULE — READ FIRST
...
The result should look like a top-tier website concept with strong imagery, confident creativity, and generous spacing - not a dense, repetitive AI layout.`,
  whenToUse: "Use when you need to automate imagegen frontend web processes.",
  price: "Free",
  priceUsdc: 0,
  category: "skill",
  tags: ["Leonxlnx-skills","imagegen-frontend-web","image","design"],
  stars: 274,
  weeklyInstalls: 192,
  totalPurchases: 881,
  featured: false,
  ...
  fileUrl: 'https://github.com/Leonxlnx/taste-skill/tree/main/skills/imagegen-frontend-web',
  useCases: ["Generate one separate horizontal image PER section. Always. No exceptions.","1 section requested -> 1 image.","4 sections requested -> 4 images."],
  ...
  overviewHtml: `<div class="skill-enrichment" style="display: flex; flex-direction: column; gap: 32px;">
      <div class="enrich-hero" style="position: relative; border-radius: 12px; overflow: hidden; border: 1px solid rgba(255, 196, 129, 0.14); box-shadow: 0 12px 32px rgba(0, 0, 0, 0.4);">
        ...
        <div style="position: absolute; bottom: 20px; left: 24px; right: 24px;">
          <h2 style="font-family: var(--font-display); color: var(--color-accent-warm-light); margin: 0; font-size: 28px; font-weight: 500; letter-spacing: 0.02em;">Imagegen frontend web</h2>
          <p style="margin: 6px 0 0; color: var(--color-text-secondary); font-size: 14px; max-width: 600px;">Elite frontend image-direction skill for generating premium, conversion-aware website design references.</p>
        </div>
      </div>
      ...
      <div style="display: grid; grid-template-columns: 1.2fr 1.0fr; gap: 32px; align-items: start;">
        <div>
          ...
          <p style="margin-bottom: 24px; font-size: 13.5px; line-height: 1.65; color: var(--color-text-secondary);">Elite frontend image-direction skill for generating premium, conversion-aware website design references. CRITICAL OUTPUT RULE — generate ONE separate horizontal image FOR EVERY section. A landing page with 8 sections produces 8 images. Never compress multiple sections into one image. Enforces composition variety (not always left-text / right-image), background-image freedom, varied CTAs, varied hero scales (giant / mid / mini minimalist), narrative concept spine, second-read moments, and a single consistent palette across all images. Optimized for landing pages, marketing sites, and product comps that developers or coding models can accurately recreate.</p>
