...
Custom configurations via EXTEND.md. See **Preferences** section for paths and supported options.`,
  ...
  useCases: ["Translate technical documentations without altering code blocks.","Localize blog articles while preserving nuances and idioms.","Convert marketing pages between English, Chinese, Japanese, and more."],
  exampleUsage: "Translate my document into English while preserving formatting",
