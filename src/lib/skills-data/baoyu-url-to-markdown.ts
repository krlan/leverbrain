...
Custom configurations via EXTEND.md. See **Preferences** section above for paths and supported keys.`,
  ...
  useCases: ["Save online reference documentation for offline search.","Feed clean article content into LLM context windows.","Archive web essays into personal markdown journals."],
  exampleUsage: "Convert any URL into clean markdown for my notes",
